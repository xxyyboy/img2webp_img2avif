...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/data/nginx/SecNginx1202/3partylib/ffmpeg60/ --disable-x86asm
...
CC_IDENT=gcc 4.8.5 (GCC) 20150623 (Red Hat 4.8.5-4)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -I$(SRC_PATH)/compat/atomics/gcc -DZLIB_CONST
CFLAGS=   -std=c11 -fomit-frame-pointer  -pthread      -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shm -lxcb-shape -lxcb-xfixes
...
EXTRALIBS-avutil=-pthread -lm -lX11
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
