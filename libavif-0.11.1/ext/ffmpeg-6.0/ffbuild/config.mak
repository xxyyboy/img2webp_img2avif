...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/data/nginx/SecNginx1202/3partylib/libavif-0.11.1/ext/ffmpeg60/ --enable-static --enable-libaom
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -latomic -lxcb -lxcb-shm -lxcb-shape -lxcb-xfixes
...
EXTRALIBS-avcodec=-pthread -lm -latomic -llzma -L/usr/local/lib64 -laom -lz
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -lm -latomic -lX11
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
